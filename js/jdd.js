...
/**
 * The CouchDBDocHistoryChanges object handles all of the functions for the main page.  It finds the diffs and manages
 * the interactions of displaying them.
 */
/*global CouchDBDocHistoryChanges:true */
var jdd = {
    ...
    generateReport: function () {
        ...
        var newDiff = $('<button>Reset</button>');
    ...
    compare: function () {
        ...
        //console.log('diffs: ' + JSON.stringify(CouchDBDocHistoryChanges.diffs));
